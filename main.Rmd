...
The link to our youtube video : [here](https://youtu.be/1iJWN-v1mvI)

# Setup
```{r setup_13, message=FALSE, include=TRUE, results=FALSE}
library(tidyverse)
library(sf)
library(lubridate)
library(tigris)
...
```{r get_census, message=FALSE, warning=FALSE, results=F}
census <- 
