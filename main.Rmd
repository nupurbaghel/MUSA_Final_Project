...
pred = predict(rf, newdata=dat.Test %>% select(from, to, total_stops, hour, dotw, train_id, Wind_Speed, Temperature, Precipitation, dist, lag_1day, lag_1week, lag_2week, congestion, critical, a), na.action = na.exclude)
library(Metrics)
mse(pred, dat.Test[,11])
```
