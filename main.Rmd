...
ggplot() +
  geom_histogram(data = njstation_critical_station, aes())
```
...
```{r}
library(geosphere)
distm (c(2492491.95052859, 5556119.56165213), c(, lat2), fun = distHaversine)
```
...
dat_njstation <- cbind(dat_njstation, diff_delay_var)
```
